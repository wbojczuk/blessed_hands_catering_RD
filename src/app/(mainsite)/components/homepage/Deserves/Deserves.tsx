...
import styles from './deserves.module.css';

export default function Deserves(){
return (
 <div className={styles.deserves}>
    <h2>Everyone Deserves<br />The Best</h2>
    <p>we firmly believe that every customer deserves to be treated with the utmost care and attention, regardless of the size of their event. From intimate gatherings to grand celebrations, our commitment to excellence in service remains unwavering.</p>
