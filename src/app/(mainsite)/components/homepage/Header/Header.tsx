...
return (
 <header className={styles.header}>
    ...
    <h1>Food to Make<br />The Soul <span className="underline">Happy</span></h1>

    <p>We believe in nourishing both body and soul with our culinary creations. At Blessed Hands Catering, we specialize in creating catering experiences that leave a lasting impression.</p>
    ...
    <img src='/img/header-bg.webp' alt='Image of food' className='bg-img' />
