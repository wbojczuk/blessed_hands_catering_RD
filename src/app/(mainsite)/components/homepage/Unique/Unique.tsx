  ...
  return (
    <section className={styles.section}>
        <div className={styles.imgWrapper}>
            <img className={styles.img} src="/img/food-on-shelf.png" width={360} height={600} alt="image of food on shelf" />
        </div>
        ...
        <div className={styles.content}>
            ...
            <p>We understand that dietary preferences and restrictions vary among our clients. That's why we proudly offer custom menus for each event, completely free of charge. We're dedicated to accommodating your needs without any additional fees.
            <br /><br />
            When you choose us for your event, you can be sure that every detail will be handled with care and attention, leaving you free to be in the moment and enjoy the experience.
            </p>
