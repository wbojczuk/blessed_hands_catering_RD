  ...
  return (
    <section className={styles.section}>
        <div className={styles.imgWrapper}>
            <img className={styles.img} src="/img/food-on-shelf.webp" width={360} height={600} alt="Image of catering food" />
        </div>
        

        <div className={styles.content}>
            <h4>Meet Us</h4>
            <h2>Meet Blessed Hands</h2>

            <p>Chef Stephanie has spent over 30 years in the industry and wanted to create a different experience for customers small and large.
              <br /><br /> Blessed hands Catering has a staff trained in culinary and customer service so that we can handle all of your needs
            </p>
